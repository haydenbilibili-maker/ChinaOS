...
应用按 **19 个功能分组**、**279 个注册模块**组织（其中 277 个侧栏可见入口；截至 2026-07-23），主要能力概览如下：
...
| **史鉴·中华 / 史鉴·世界** | SJ-00~57、SJW-00~32 | 双一级分类、主题带导航、单文件史册与跨线映射 |
| **推演与训练** | 治国沙盒、三体总论、领袖统治、人才精英库、政令文库… | 情景推演、思想实验、人物图谱与政策文本挖掘 |
| **治理结构** | 观象台、信号灯、三力监测仪、归因分析器 | 公开信号的结构化观测与归因 |
...
npm run check      # registry/路由 + UI + 史鉴双线 + Vitest
```
