...
const SECTORS = [
  ...
  },
  {
    ...
    scale: '一体化政务平台注册用户 10 亿+', cases: '浙里办 / 粤省事 / 随申办 / 数字通行凭证遗产',
    cycle: '政务上网 → 一网通办 → 数据共享 → 城市大脑',
    tension: '治理效率与个体数据权利的平衡未定型；疫情期数字通行凭证证明了动员能力，也留下了权力边界议题。',
    trend: { unit: '亿人', data: [2.4, 3.9, 8.1, 9.2, 9.7, 10.2, 10.6], note: '在线政务服务用户规模：封控周期完成强制性普及。' },
    donut: [
