...
const MAP = {
  ...
  dashboard: [
    ...
    { to: '/econ-consume-15th', label: '十五五促消费 · 扩大消费规划', note: '国函〔2026〕66 号。' },
  ...
  econdash: [
    ...
    { to: '/econ-consume-15th', label: '十五五促消费 · 扩大消费规划', note: '国函〔2026〕66 号 · 消费长效机制。' },
  ...
  econH1Review: [
    ...
    { to: '/econ-consume-15th', label: '十五五促消费 · 扩大消费规划', note: '对供强需弱的中期制度回应。' },
