...
const MAP = {
  ...
  shijianWorldSJW00: [
    ...
    { to: '/modules/shijian-world/sjw-19', label: 'SJW-19 · 大革命', note: 'Round 5：合法性—动员秩序实验。' },
    { to: '/modules/shijian-world/sjw-22', label: 'SJW-22 · 改革对照', note: 'Round 5：发展型中国外卷。' },
    { to: '/modules/shijian-world/sjw-23', label: 'SJW-23 · 发展型矩阵', note: 'Round 5：日韩新中谱系综合。' },
