...
/** 各模块横向互链 · 单一数据源 */
const SLICE_N = POPULATION_SLICE_COUNT;
const MAP = {
  soe: [
  ...
  deterrence: [
    ...
    { to: '/modules/shijian-world/sjw-08', label: 'SJW-08 · 核威慑机制史', note: '冷战编年台账；本页=谢林工具箱——职责不合并。' },
  ...
  energy: [
    ...
    { to: '/modules/shijian-world/sjw-21', label: 'SJW-21 · 石油中东', note: '能源基座地缘落地案。' },
  ],
  private: [
  ...
  dashboard: [
    ...
    { to: '/econ-dashboard?tab=h1review', label: '半年经济解读 · 2026 H1', note: '三驾马车与供强需弱。' },
    { to: '/econ-dashboard?tab=consume15', label: '十五五促消费 · 大盘 Tab', note: '扩大消费规划全文解读（国函66号）。' },
  ...
  econH1Review: [
    ...
    { to: '/consumption', label: '扩大内需 · 消费率', note: '消费结构再平衡长周期。' },
    { to: '/econ-dashboard?tab=worldbank', label: '世行经济简报', note: '基线预测交叉验证。' },
  ],
  econConsume15: [
    { to: '/econ-dashboard', label: '经济大盘 · 2026 H1', note: 'KEY_INDICATORS 同源读数。' },
    { to: '/econ-dashboard?tab=h1review', label: '半年经济解读 · 2026 H1', note: '社零偏弱与三驾马车拆解。' },
    { to: '/consumption', label: '扩大内需 · 消费率', note: '预防性储蓄与消费率。' },
    { to: '/silver-economy', label: '银发经济', note: '规划九专栏之一的场景落地。' },
  ],
  observatory: [
  ...
  attribution: [
    ...
    { to: '/modules/signal-panel', label: '宏观再平衡信号灯', note: '通缩/再平衡议题的层位交叉验证。' },
  ...
  threeForces: [
    ...
    { to: '/reform', label: '改革开放 · 算法演进', note: '外部压力逼 reform 的历史参照。' },
  ...
  premierRadius: [
    ...
    { to: '/modules/cushion-monitor', label: '垫子厚度监测', note: '未富先躺与处方权分离的对照读数。' },
    { to: '/powerlogic', label: '权力逻辑 · 统治成本', note: '决策层上移的制度逻辑。' },
  ...
  culture: [
    ...
    { to: '/modules/shijian/sj-22', label: '文化映射 · SJ-22', note: '合法性叙事力古今对照：象征通胀、文教投入、思想边界。' },
  ],
  aiplus: [
  ...
  renqunTupu: [
    ...
    { to: '/modules/shijian/sj-23', label: '社会映射 · SJ-23', note: '基座力古今对照：承载上限、流民变体、人口结构容错。' },
  ],
  guoyun: [
    ...
    { to: '/modules/shijian/sj-20', label: '政治映射 · SJ-20', note: '精英循环、合法性叙事、央地钟摆的古今对照。' },
    { to: '/modules/shijian/sj-23', label: '社会映射 · SJ-23', note: '基座力承载维度：人口结构与社会张力。' },
  ...
  qingnian: [
    { to: '/modules/renqun-tupu', label: '人群画像总图谱 · GY-00', note: `人群分层母索引，${SLICE_N} 片切片与八轴配平图谱。` },
    ...
    { to: '/modules/shijian/sj-20', label: '政治映射 · SJ-20', note: '精英循环通道的历史纵深对照。' },
  ...
  linggong: [
    ...
    { to: '/modules/shijian/sj-23', label: '社会映射 · SJ-23', note: '流民变体：灵活就业与基座承载的古今对照。' },
  ...
  yishixingtai: [
    ...
    { to: '/modules/shijian/sj-22', label: '文化映射 · SJ-22', note: '合法性叙事力古今对照：象征通胀与意识形态再生产。' },
  ...
  shijianSJ05: [
    { to: '/modules/shijian/sj-02', label: 'SJ-02 · 四步法', note: '本案是四步引擎首验：台账七字段全部跑通。' },
    { to: '/modules/shijian/sj-03', label: 'SJ-03 · 五力衰变', note: '变法卷五力归因台账的来源力场。' },
    { to: '/modules/shijian/sj-04', label: 'SJ-04 · 相位罗盘', note: '王安石变法定位僵化期早段。' },
    { to: '/modules/shijian/sj-20', label: 'SJ-20 · 政治映射', note: '党争与精英循环力的单案深描。' },
    { to: '/modules/shijian/sj-21', label: 'SJ-21 · 经济映射', note: '与民争利之辩的古今回响。' },
    { to: '/modules/yishixingtai', label: '合法性机器 · GY-02', note: '古今映射关键差异：列宁式组织基层穿透。' },
    { to: '/reform', label: '改革开放 · 改革透镜', note: '当代改革与变法的结构对照入口。' },
  ],
  shijianSJ06: [
    { to: '/modules/shijian/sj-03', label: 'SJ-03 · 五力衰变', note: '内轻外重：军事力畸大压制其余四力。' },
    { to: '/modules/shijian/sj-04', label: 'SJ-04 · 相位罗盘', note: '开元→天宝：鼎盛顶点转入崩解触发。' },
    { to: '/modules/shijian/sj-07', label: 'SJ-07 · 崩解对比', note: '内轻外重型崩解的跨案对照。' },
    { to: '/modules/shijian/sj-20', label: 'SJ-20 · 政治映射', note: '央地授权过度→尾大不掉的原型。' },
    { to: '/military', label: '军事力量 · 国防', note: '节度使问题的当代制度性根除对照。' },
  ],
  shijianSJ07: [
    { to: '/modules/shijian/sj-03', label: 'SJ-03 · 五力衰变', note: '崩解归因矩阵的五力列来源。' },
    { to: '/modules/shijian/sj-06', label: 'SJ-06 · 天宝之乱', note: '内轻外重型崩解单案。' },
    { to: '/modules/shijian/sj-08', label: 'SJ-08 · 五代十国', note: '分裂期作为超稳定结构压力测试。' },
    { to: '/modules/shijian/sj-21', label: 'SJ-21 · 经济映射', note: '明末三饷：财政枢纽越阈引爆崩解。' },
    { to: '/debt', label: '地方债务 · 热力图', note: '当代财政压力的可视化接口。' },
  ],
  shijianSJ08: [
    { to: '/modules/shijian/sj-03', label: 'SJ-03 · 五力衰变', note: '军事力畸大压制其余四力的分裂期标本。' },
    { to: '/modules/shijian/sj-04', label: 'SJ-04 · 相位罗盘', note: '五代定位重整期；宋过度矫正→积弱。' },
    { to: '/modules/shijian/sj-07', label: 'SJ-07 · 崩解对比', note: '分裂—重整与崩解的对比解剖。' },
  ...
  shijianSJ20: [
    ...
    { to: '/modules/shijian/sj-08', label: 'SJ-08 · 五代十国', note: '央地钟摆与过度矫正的原型。' },
    { to: '/modules/shijian/sj-21', label: 'SJ-21 · 经济映射', note: '政治—经济映射姊妹卷。' },
    { to: '/modules/shijian/sj-22', label: 'SJ-22 · 文化映射', note: '合法性叙事力的文化域展开。' },
    { to: '/modules/yishixingtai', label: '合法性机器 · GY-02', note: '合法性叙事力的当代形态。' },
    { to: '/modules/qingnian', label: '青年 · GY-03', note: '精英循环通道当代形态。' },
  ],
  shijianSJ21: [
    { to: '/modules/shijian/sj-03', label: 'SJ-03 · 五力衰变', note: '财政汲取力：枢纽力定义与修复谱系。' },
    { to: '/modules/shijian/sj-05', label: 'SJ-05 · 王安石变法', note: '与民争利之辩的宋代回合。' },
    { to: '/modules/shijian/sj-07', label: 'SJ-07 · 崩解对比', note: '明末三饷：财政枢纽越阈极端例。' },
    { to: '/modules/shijian/sj-20', label: 'SJ-20 · 政治映射', note: '央地财政分成与政治钟摆互为里表。' },
    { to: '/soe', label: '国有资本 · 国资', note: '盐铁↔国资映射的当代接口。' },
    { to: '/debt', label: '地方债务 · 热力图', note: '土地财政与地方债的量化读数。' },
  ],
  shijianSJ22: [
    { to: '/modules/shijian/sj-03', label: 'SJ-03 · 五力衰变', note: '合法性叙事力：象征通胀机制。' },
    { to: '/modules/shijian/sj-20', label: 'SJ-20 · 政治映射', note: '天命→绩效+意识形态的政治域姊妹篇。' },
    { to: '/modules/yishixingtai', label: '合法性机器 · GY-02', note: '叙事再生产能力的当代形态。' },
    { to: '/culture', label: '文化软实力 · 国潮', note: '文教象征投入的当代接口。' },
    { to: '/modules/shijian/sj-23', label: 'SJ-23 · 社会映射', note: '合法性叙事与社会张力的交互。' },
  ],
  shijianSJ23: [
    { to: '/modules/shijian/sj-03', label: 'SJ-03 · 五力衰变', note: '生态—人口—技术基座力定义。' },
    { to: '/modules/renqun-tupu', label: '人群画像总图谱 · GY-00', note: '基座力在当代的 58 片人群切片接口。' },
    { to: '/modules/linggong', label: '零工经济 · GY-05', note: '流民变体：灵活就业与悬空基础设施。' },
    { to: '/demographic', label: '人口结构 · 负增长', note: '抚养比、老龄化宏观读数。' },
    { to: '/modules/shijian/sj-22', label: 'SJ-22 · 文化映射', note: '社会张力与合法性叙事的交互。' },
    { to: '/modules/shijian/sj-24', label: 'SJ-24 · 外交映射', note: '基座约束与外部压力的耦合。' },
  ],
  shijianSJ24: [
    { to: '/modules/shijian/sj-03', label: 'SJ-03 · 五力衰变', note: '边疆—军事力定义与财政耦合。' },
    { to: '/modules/shijian/sj-07', label: 'SJ-07 · 崩解对比', note: '三饷加派：军费—财政枢纽越阈。' },
    { to: '/diplomacy', label: '外交博弈 · 区域纵横', note: '秩序话语与区域博弈当代接口。' },
  ...
  santi: [
    ...
    { to: '/modules/shijian-world/sjw-08', label: 'SJW-08 · 核威慑机制史', note: '制度指挥链 ≠ 执剑人——史鉴编年与思想实验强制关键差异。' },
  ...
  shijianWorldSJW01: [
    ...
    { to: '/modules/shijian-world/sjw-07', label: 'SJW-07 · 英美霸权', note: '崛起谱系中的英美交接深描。' },
    { to: '/thucydides', label: '修昔底德陷阱', note: '相对力量窗口机制对照。' },
  ],
  shijianWorldSJW02: [
    { to: '/modules/shijian-world', label: 'SJW-00 · 世界总索引', note: '返回世界线 Hub。' },
    { to: '/realism', label: '现实主义', note: '联盟与安全困境。' },
    { to: '/modules/shijian-world/sjw-08', label: 'SJW-08 · 核威慑', note: '核天花板如何改写一战式升级函数。' },
    { to: '/modules/shijian-world/sjw-20', label: 'SJW-20 · 德国转移', note: 'Round 5：大战前权力转移前史。' },
    { to: '/deterrence', label: '威慑战略', note: '核时代升级函数的关键差异出口。' },
  ],
  shijianWorldSJW03: [
    { to: '/modules/shijian-world', label: 'SJW-00 · 世界总索引', note: '返回世界线 Hub。' },
    { to: '/modules/shijian/sj-07', label: 'SJ-07 · 崩解矩阵', note: '多力共振同构；党国联邦 vs 帝制郡县为关键差异。' },
    { to: '/modules/shijian-world/sjw-05', label: 'SJW-05 · 社运谱系', note: '运动谱系 → 苏联国家形态前史。' },
  ...
  shijianWorldSJW05: [
    { to: '/modules/shijian-world', label: 'SJW-00 · 世界总索引', note: '返回世界线 Hub。' },
    { to: '/modules/shijian-world/sjw-03', label: 'SJW-03 · 苏联', note: '谱系政权化终点的国家五轴深描。' },
    { to: '/modules/shijian/sj-20', label: 'SJ-20 · 政治映射', note: '精英组织形态对照——强制关键差异。' },
    { to: '/modules/santi', label: '三体透镜', note: '动员叙事可对照；禁止导出黑暗森林规律。' },
  ],
  shijianWorldSJW06: [
    { to: '/modules/shijian-world', label: 'SJW-00 · 世界总索引', note: '返回世界线 Hub。' },
  ...
  shijianWorldSJW07: [
    ...
    { to: '/modules/shijian-world/sjw-20', label: 'SJW-20 · 德国转移', note: 'Round 5：大陆挑战者 vs 英美合作交接——关键差异。' },
  ],
  shijianWorldSJW08: [
    { to: '/modules/shijian-world', label: 'SJW-00 · 世界总索引', note: '返回世界线 Hub。' },
    { to: '/deterrence', label: '威慑战略', note: '谢林工具箱；本卷=冷战机制史——职责划界。' },
  ...
  shijianWorldSJW10: [
    ...
    { to: '/modules/shijian-world/sjw-24', label: 'SJW-24 · 韩国发展型', note: 'Round 6：发展型河道韩案深描。' },
    { to: '/modules/shijian-world/sjw-25', label: 'SJW-25 · 拉美债务', note: 'Round 6：资源/ISI 河道对照。' },
  ...
  shijianWorldSJW12: [
    ...
    { to: '/modules/shijian-world/sjw-19', label: 'SJW-19 · 大革命', note: 'Round 5：拿破仑冲击前史。' },
  ...
  shijianWorldSJW15: [
    ...
    { to: '/modules/shijian-world/sjw-23', label: 'SJW-23 · 发展型矩阵', note: 'Round 5：日本行收入谱系综合。' },
  ...
  shijianWorldSJW18: [
    ...
    { to: '/modules/shijian-world/sjw-21', label: 'SJW-21 · 石油中东', note: 'Round 5：能源基座地缘落地案。' },
    { to: '/energy', label: '能源 · 压舱石', note: '当代工具箱；本卷=机制史台账——职责不合并。' },
    { to: '/modules/santi', label: '三体透镜', note: '行星资源可对照；禁止黑暗森林抢碳预算。' },
  ],
  shijianWorldSJW19: [
    { to: '/modules/shijian-world', label: 'SJW-00 · 世界总索引', note: '返回世界线 Hub。' },
    { to: '/modules/shijian-world/sjw-12', label: 'SJW-12 · 维也纳', note: '拿破仑冲击后的正统—均势回摆。' },
    { to: '/modules/shijian-world/sjw-20', label: 'SJW-20 · 德国转移', note: '民族动员遗产下游。' },
    { to: '/modules/shijian/sj-20', label: 'SJ-20 · 政治映射', note: '合法性重建对照——强制关键差异。' },
    { to: '/modules/santi', label: '三体透镜', note: '革命动员 ≠ 宇宙社会学——命名不合并。' },
  ],
  shijianWorldSJW20: [
    { to: '/modules/shijian-world', label: 'SJW-00 · 世界总索引', note: '返回世界线 Hub。' },
    { to: '/modules/shijian-world/sjw-02', label: 'SJW-02 · 世界大战', note: '联盟死结下游。' },
    { to: '/modules/shijian-world/sjw-07', label: 'SJW-07 · 英美霸权', note: '合作交接 vs 大陆挑战——关键差异。' },
    { to: '/modules/shijian-world/sjw-19', label: 'SJW-19 · 大革命', note: '民族动员前史接口。' },
    { to: '/thucydides', label: '修昔底德陷阱', note: '德案窗口 ≠ 英美模板——强制关键差异。' },
  ],
  shijianWorldSJW21: [
    { to: '/modules/shijian-world', label: 'SJW-00 · 世界总索引', note: '返回世界线 Hub。' },
    { to: '/modules/shijian-world/sjw-18', label: 'SJW-18 · 能源基座', note: '本卷为碳基地缘落地案。' },
    { to: '/modules/shijian-world/sjw-16', label: 'SJW-16 · 货币锚', note: '石油美元与危机外部项。' },
    { to: '/modules/shijian-world/sjw-10', label: 'SJW-10 · 发展型/资源', note: '租金河道交叉。' },
    { to: '/energy', label: '能源 · 压舱石', note: '当代工具箱；本卷=历史地缘——职责不合并。' },
  ],
  shijianWorldSJW22: [
    { to: '/modules/shijian-world', label: 'SJW-00 · 世界总索引', note: '返回世界线 Hub。' },
    { to: '/modules/shijian-world/sjw-10', label: 'SJW-10 · 发展型总论', note: '谱系入口。' },
    { to: '/modules/shijian-world/sjw-15', label: 'SJW-15 · 日本发展型', note: '东亚对照行。' },
    { to: '/modules/shijian-world/sjw-23', label: 'SJW-23 · 发展型矩阵', note: '中国行收入综合矩阵。' },
    { to: '/modules/shijian/sj-21', label: 'SJ-21 · 经济映射', note: '中华线细节真源；本卷不改写 SJ 正文。' },
    { to: '/thucydides', label: '修昔底德陷阱', note: '发展追赶 ≠ 挑战者宿命——划界。' },
  ],
  shijianWorldSJW23: [
    { to: '/modules/shijian-world', label: 'SJW-00 · 世界总索引', note: '返回世界线 Hub。' },
    { to: '/modules/shijian-world/sjw-10', label: 'SJW-10 · 发展型总论', note: '矩阵成员：定义入口。' },
    { to: '/modules/shijian-world/sjw-15', label: 'SJW-15 · 日本', note: '矩阵成员：深描。' },
    { to: '/modules/shijian-world/sjw-22', label: 'SJW-22 · 中国对照', note: '矩阵成员：世界线外卷。' },
    { to: '/modules/shijian-world/sjw-24', label: 'SJW-24 · 韩国', note: 'Round 6：韩国行深描析出。' },
    { to: '/modules/shijian-world/sjw-27', label: 'SJW-27 · 台湾对照', note: 'Round 6：东亚行补齐对照短卷。' },
    { to: '/modules/shijian-world/sjw-17', label: 'SJW-17 · 去殖民矩阵', note: '关联：区域分叉层。' },
    { to: '/modules/shijian/sj-21', label: 'SJ-21 · 经济映射', note: '汲取—学习同构；禁儒家常数。' },
  ],
  shijianWorldSJW24: [
    { to: '/modules/shijian-world', label: 'SJW-00 · 世界总索引', note: '返回世界线 Hub。' },
    { to: '/modules/shijian-world/sjw-23', label: 'SJW-23 · 发展型矩阵', note: '本卷自韩国矩阵行析出。' },
    { to: '/modules/shijian-world/sjw-15', label: 'SJW-15 · 日本', note: '出口纪律同构；财阀 vs 系列企业——关键差异。' },
    { to: '/modules/shijian-world/sjw-27', label: 'SJW-27 · 台湾对照', note: 'SME/代工路径对照。' },
    { to: '/modules/shijian-world/sjw-10', label: 'SJW-10 · 发展型总论', note: '河道定义入口。' },
    { to: '/modules/shijian/sj-21', label: 'SJ-21 · 经济映射', note: '国家能力×学习——关键差异。' },
  ],
  shijianWorldSJW25: [
    { to: '/modules/shijian-world', label: 'SJW-00 · 世界总索引', note: '返回世界线 Hub。' },
    { to: '/modules/shijian-world/sjw-17', label: 'SJW-17 · 去殖民矩阵', note: '本卷自拉美河道析出。' },
    { to: '/modules/shijian-world/sjw-10', label: 'SJW-10 · 发展型/资源', note: '三河道总论对照。' },
    { to: '/modules/shijian-world/sjw-16', label: 'SJW-16 · 货币锚', note: '石油美元与利率外部项。' },
    { to: '/modules/shijian-world/sjw-24', label: 'SJW-24 · 韩国', note: '出口纪律 vs ISI——关键差异。' },
    { to: '/modules/shijian/sj-21', label: 'SJ-21 · 经济映射', note: '汲取—学习同构；辛迪加债不可裸比。' },
  ],
  shijianWorldSJW26: [
    { to: '/modules/shijian-world', label: 'SJW-00 · 世界总索引', note: '返回世界线 Hub。' },
    { to: '/modules/shijian-world/sjw-16', label: 'SJW-16 · 货币锚', note: '本卷承接后广场欧洲锚实验。' },
    { to: '/modules/shijian-world/sjw-07', label: 'SJW-07 · 英美霸权', note: '美元锚 vs 多主权契约货币——关键差异。' },
    { to: '/modules/shijian-world/sjw-12', label: 'SJW-12 · 维也纳', note: '欧洲秩序容器长波关联。' },
    { to: '/modules/shijian/sj-21', label: 'SJ-21 · 经济映射', note: '承诺装置同构；无统一财政缺口。' },
  ],
  shijianWorldSJW27: [
    { to: '/modules/shijian-world', label: 'SJW-00 · 世界总索引', note: '返回世界线 Hub。' },
    { to: '/modules/shijian-world/sjw-15', label: 'SJW-15 · 日本', note: '对照行：系列企业路径。' },
    { to: '/modules/shijian-world/sjw-24', label: 'SJW-24 · 韩国', note: '对照行：财阀路径。' },
    { to: '/modules/shijian-world/sjw-23', label: 'SJW-23 · 发展型矩阵', note: '东亚谱系综合层。' },
    { to: '/modules/shijian-world/sjw-10', label: 'SJW-10 · 发展型总论', note: '河道定义入口。' },
