...
const MAP = {
  ...
  dashboard: [
    ...
    { to: '/econ-h1-review', label: '半年经济解读 · 2026 H1', note: '三驾马车与供强需弱。' },
    { to: '/econ-dashboard?tab=consume15', label: '十五五促消费 · 大盘 Tab', note: '规划摘要；全文见页内出口。' },
  ...
  econdash: [
    ...
    { to: '/econ-h1-review', label: '半年经济解读 · 2026 H1', note: '三驾马车拆解与供强需弱研判。' },
    { to: '/econ-consume-15th', label: '十五五促消费 · 全文解读', note: '国函〔2026〕66 号 · 与大盘 Tab 互补。' },
  ...
  econH1Review: [
    ...
    { to: '/econ-dashboard?tab=consume15', label: '十五五促消费 · 大盘 Tab', note: '对供强需弱的中期制度回应；全文可从 Tab 内链出。' },
  ...
  econConsume15: [
    ...
    { to: '/econ-dashboard?tab=consume15', label: '经济大盘 · 促消费 Tab', note: '规划摘要速览。' },
    { to: '/econ-h1-review', label: '半年经济解读 · 2026 H1', note: '社零偏弱与三驾马车拆解。' },
