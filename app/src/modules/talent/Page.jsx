...
const ROLE_OPTS = ['总书记', '总理', '副总理', '国务委员', '人大委员长', '政协主席', '政协副主席', '政协秘书长', '纪委书记', '外交部长', '政法委书记', '中组部部长', '统战部部长', '中宣部部长', '人大副委员长', '人大秘书长', '监委主任', '军委副主席', '港澳办主任', '党委书记', '市委书记', '省委副书记', '省长', '市长', '常务副市长', '自治区主席', '部长', '国防部长', '署长', '局长', '主任', '主席', '董事长', '最高法院长', '最高检检察长'];
const SECTOR_OPTS = ['国务院', '党中央', '国家机关', '全国政协', '国务院直属机构', '央企', '军队', '地方'];
