...
const EVOLUTION = [
  ...
  { period: '2020–', title: '智慧治理 / 全要素网格', accent: '#c41e3a', desc: '封控周期完成了治理基础设施的压力测试与极限扩容：数字通行凭证、门磁、社区团购链路证明网格可在 48 小时内切换为战时动员模式。此后「全要素网格」「一网统管」常态化 —— 传感器密度与数据穿透力成为治理能力的硬通货。' },
];
