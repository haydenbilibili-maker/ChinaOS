// 国运时间轴 · 1949→2026 —— 七个时代 × 六域大事记，长周期结构演化的经验底片
...
export default function ChroniclePage() {
  ...
  return (
    <div>
      <PageHeader
        badge="Chronicle · 国运时间轴"
        title="国运时间轴 · 1949→2026"
        subtitle={`七个时代 · 六域大事记 · ${EVENTS.length} 个节点 —— 把今日处境放回 77 年的结构演化里读 · 截至 ${AS_OF}`}
      />
      ...
      <ModuleFooter
        ...
        links={[
          ...
          { to: '/civilization', label: '文明透视', note: '更长时段的结构底片' },
        ]}
