 ...
 * 大盘数据最近一次对齐官方发布的时点」。2026-08-17 国家统计局公布 2026 年 1–7 月
 * 国民经济运行情况，本层 KEY_INDICATORS 已同步至该批月度累计读数（GDP 仍为
 * 2026-07-15 发布的上半年口径，因季报尚未更新）；故取发布日 2026-08-17。
 * 陈旧判定（见 lib/time/dataFreshness.js）以此值为数据时间戳。后续每次纳入新一
 * 轮官方发布，只需上调此常量。
 */
export const ECON_DATA_AS_OF = '2026-08-17';
...
export const KEY_INDICATORS = [
  {
    ...
    good: 'band',
    asOf: ECON_AS_OF,
    note: '1–7 月同比 +0.9%，核心 CPI +1.1%；7 月同比 +0.5%、环比 -0.1%。涨幅收窄，猪肉 -13.4% 仍拖累食品。（2026 1–7 月·NBS 2026-08-17）',
  },
  {
    id: 'ppi',
    label: 'PPI 工业生产者出厂价',
    ...
    good: 'band',
    asOf: ECON_AS_OF,
    note: '7 月同比 +3.5%（环比 -0.7%），1–7 月累计 +1.8%；购进价格 7 月 +5.5%、累计 +2.8%。工业品价格高位回落。（2026 1–7 月·NBS 2026-08-17）',
  },
  {
    id: 'pmi_mfg',
    label: '制造业 PMI',
    ...
    good: 'high',
    asOf: ECON_AS_OF,
    note: '7 月制造业 PMI 49.2，较上月降 1.1pct 回落至荣枯线下；生产经营活动预期指数 54.1。（2026 7 月·NBS）',
  },
  {
    id: 'pmi_nonmfg',
    label: '非制造业 PMI',
    ...
    good: 'high',
    asOf: ECON_AS_OF,
    note: '7 月非制造业商务活动指数 49.0（降 1.2pct）；服务业 49.3、建筑业 47.0；邮政/电信广电/文体娱乐仍位于 55 以上。（2026 7 月·NBS）',
  },
  {
    id: 'urban_unemp',
    label: '城镇调查失业率',
    ...
    good: 'low',
    asOf: ECON_AS_OF,
    note: '7 月 5.2%（环比 +0.2pct，季节性上升），1–7 月均值 5.2%；31 大城市 5.2%。总量平稳，青年与结构性压力另见金丝雀盘。（2026 1–7 月·NBS）',
  },
  {
    id: 'm2',
    label: 'M2 货币供应增速',
    ...
    good: 'band',
    asOf: ECON_AS_OF,
    note: '广义货币增速；高于名义 GDP 即偏宽松，但传导到实体仍偏弱；近似值（本轮未随 1–7 月 NBS 主稿更新）。',
  },
  {
    id: 'afre',
    label: '社融存量增速',
    ...
    good: 'high',
    asOf: ECON_AS_OF,
    note: '社会融资规模存量同比；政府债拉动为主，企业中长贷需求偏弱；近似值（本轮未随 1–7 月 NBS 主稿更新）。',
  },
  {
    id: 'retail',
    label: '社会消费品零售总额',
    ...
    good: 'high',
    asOf: ECON_AS_OF,
    note: '1–7 月社零 287744 亿元 +1.2%（7 月 +0.6%、环比 +0.06%）；服务零售 +5.0% 强于商品 +1.1%，通讯器材 +15.1%、餐饮 +2.6%。需求侧仍偏弱。（2026 1–7 月·NBS 2026-08-17）',
  },
  {
    id: 'fai',
    label: '固定资产投资',
    ...
    good: 'high',
    asOf: ECON_AS_OF,
    note: '1–7 月固投（不含农户）260328 亿元 -6.7%（扣除地产 -3.7%）；地产开发投资 -19.2%、制造业 -1.7%、基建 -3.6%、民间 -9.4%；知识产权产品投资 +9.1%、高技术产业投资 +5.0% 逆势。（2026 1–7 月·NBS 2026-08-17）',
  },
  {
    id: 'gdp_h1',
    label: 'GDP 累计增速',
    ...
    good: 'high',
    asOf: ECON_AS_OF,
    note: '上半年 GDP 695704 亿元 +4.7%（一季 5.0、二季 4.3，二季环比 +0.9%）；1–7 月月度主稿未更新季报，故仍锚定 H1 口径。（2026 上半年·NBS 2026-07-15）',
  },
  {
    id: 'iva',
    label: '规上工业增加值',
    ...
    good: 'high',
    asOf: ECON_AS_OF,
    note: '1–7 月规上工业 +5.3%（7 月 +4.5%、环比 +0.11%）；装备制造 +9.7%、高技术制造 +13.8%；3D 打印 +52.3%、锂电池 +40.2%、工业机器人 +28.5%。供给端仍偏强。（2026 1–7 月·NBS 2026-08-17）',
  },
  {
    id: 'export',
    label: '出口（人民币计）',
    ...
    good: 'high',
    asOf: ECON_AS_OF,
    note: '1–7 月出口 17.44 万亿元 +14.0%（进口 +22.0%、进出口 30.13 万亿元 +17.3%）；机电产品出口 +21.2% 占比 63.8%，民企占进出口 56.9%。7 月出口当月 +17.8%。（2026 1–7 月·NBS/海关，2026-08-17）',
  },
  {
    id: 'new_afre',
    label: '新增社会融资',
    ...
    good: 'high',
    asOf: ECON_AS_OF,
    note: '当月新增社融；总量受季节与政府债节奏影响，同比波动大；近似值（本轮未随 1–7 月 NBS 主稿更新）。',
  },
];
...
export const INDICATOR_SPARKLINES = {
  ...
  cpi: [0.1, 0.3, 0.5, 0.6, 0.8, 0.9, 1.0, 0.9],
  ppi: [-2.6, -1.8, -0.6, 0.4, 1.5, 2.8, 4.1, 3.5],
  pmi_mfg: [49.7, 49.8, 49.6, 49.9, 50.0, 50.1, 50.3, 49.2],
  retail: [4.6, 3.9, 3.2, 2.6, 2.0, 1.5, 1.3, 1.2],
