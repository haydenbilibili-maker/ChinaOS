...
export const ATLAS_CLUSTERS = [
  ...
  },
  {
    ...
    slices: [
      ...
      { num: '36', axes: ['媒介', '情绪'], blurb: '情绪中断风暴 · 受众即弹药。整张图谱的情绪传导层。', sens: '情绪收束' },
    ],
  },
  {
    head: '第四批 · 服务末梢与汇流终点 · 系列收官十片',
    slices: [
      { num: '37', axes: ['健康', '劳动'], blurb: '满载的服务进程 · 医患同困。请求队列溢出的一线承载。' },
      { num: '38', axes: ['教育', '劳动'], blurb: '优先级反转 · 教学排在最后。行政压过育人的调度逻辑。' },
      { num: '39', axes: ['劳动', '底层'], blurb: '空闲轮询的待命进程 · 在场即服务。越关键越不可见的安保末梢。' },
      { num: '40', axes: ['劳动', '平台'], blurb: '竞价实例 · 一口价的运力。算法按需召唤的弹性运力。' },
      { num: '41', axes: ['劳动', '金融'], blurb: '增员制进程树 · 大进大出。繁殖人头而非创造保障的坍缩树。' },
      { num: '42', axes: ['阶层', '劳动'], blurb: '夹心资本 · 账期与融资两头挤。被上下游 I/O 同时阻塞的中间件。' },
      { num: '43', axes: ['阶层', '兜底'], blurb: '最低保活进程 · 社会救助兜底。系统不让它死掉,只给最低供电。' },
      { num: '44', axes: ['退出', '治理'], blurb: '权限残留 · 回归社会困境。刑期结束,标记不清的持久 flag。' },
      { num: '45', axes: ['城乡', '性别'], blurb: '独自维持集群的主节点 · 三留守承重轴。一人承托全家的留守承重。' },
