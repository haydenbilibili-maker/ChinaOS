...
export const FIGURE_CATALOG_META = {
  ...
  scope: `${PROV_META.scope}；${FIGURE_PROVINCIAL_EXTENDED_META.scope}；${FIGURE_CENTRAL_META.scope}；人大政协/直属机构；${FIGURE_MUNICIPAL_META.scope}；${FIGURE_PREFECTURE_CITY_META.scope}；${FIGURE_ORG_META.scope}；${FIGURE_ORG_TIER2_META.scope}`,
  notes: [PROV_META.notes, FIGURE_PROVINCIAL_EXTENDED_META.notes, FIGURE_CENTRAL_META.notes, FIGURE_MUNICIPAL_META.notes, FIGURE_PREFECTURE_CITY_META.notes, FIGURE_ORG_META.notes, FIGURE_ORG_TIER2_META.notes, '政协主席王沪宁见政治局常委'].filter(Boolean).join(' '),
  breakdown: {
