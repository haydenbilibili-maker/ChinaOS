...
export const SEARCH_INDEX_REVISION = `v15:glossary-dedup-enrich:${GLOSSARY_COUNT}:${SELF_MEDIA_DEDUPED_COUNT.total}:${CULTURAL_ELITE_DEDUPED_COUNT.total}:${DIPLOMATIC_CORPS_SEED_PKG?.rows?.length ?? 0}`;
