#!/usr/bin/env node
/** Generate SJ-52~57 Round 4 cases. Premium §02 via patch-sj-slices.mjs */
...
const CASES = [...ROUND4_CASES, ...ROUND4_CHUNQIU];
...
console.log('Done:', CASES.length, 'Round 4 case volumes');
