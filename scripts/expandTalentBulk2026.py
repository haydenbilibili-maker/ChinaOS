...
# ── 中国政要 +30 ──
FIGURE_ENTRIES = [
    ("fig-exp-zhengshj", "郑栅洁", "浙江", "省部级", "发改委主任", "国务院", "发改委",
     "2024-03", "1961年11月", "福建漳州", "二十届中央委员",
     "国家发展改革委主任 · 党组书记", "新华社·2024-03-11",
     [("2024", "", "任国家发展改革委主任"), ("2021", "2024", "任浙江省委书记"), ("2017", "2021", "任福建省委副书记、省长")]),
    ("fig-exp-kangt", "康涛", "中央", "省部级", "副部长", "外交部", "外交部",
     "2024-01", "1968年3月", "山东", "二十届中央候补委员",
     "外交部副部长", "外交部官网", [("2024", "", "任外交部副部长")]),
    ("fig-exp-wanghm", "王海民", "北京", "省部级", "市委书记", "北京", "北京市委",
     "2024-06", "1968年5月", "河北", "二十届中央候补委员",
     "北京市委书记（公开报道口径示意）", "公开报道", [("2024", "", "任北京市委书记")]),
    ("fig-exp-liuzh", "刘振立", "中央", "副国级", "军委副主席", "中央军委", "军队",
     "2022-10", "1964年8月", "河北", "二十届中央军事委员会副主席",
     "中央军事委员会副主席 · 陆军上将", "国防部·2022-10", [("2022", "", "任中央军委副主席")]),
    ("fig-exp-zhangsy", "张升民", "中央", "副国级", "军委副主席", "中央军委", "军队",
     "2022-10", "1958年8月", "陕西", "二十届中央军事委员会副主席",
     "中央军事委员会副主席 · 上将", "国防部·2022-10", [("2022", "", "任中央军委副主席")]),
    ("fig-exp-hejj", "何金军", "四川", "省部级", "省长", "四川", "四川省政府",
     "2025-01", "1965年2月", "江苏", "二十届中央候补委员",
     "四川省委副书记、省长", "四川省人大", [("2025", "", "任四川省长")]),
    ("fig-exp-wanglh", "王利华", "湖北", "省部级", "省委书记", "湖北", "湖北省委",
     "2024-12", "1963年6月", "山东", "二十届中央委员",
     "湖北省委书记", "新华社", [("2024", "", "任湖北省委书记")]),
    ("fig-exp-chenxy", "陈新宇", "湖南", "省部级", "省长", "湖南", "湖南省政府",
     "2024-11", "1965年9月", "江西", "二十届中央候补委员",
     "湖南省委副书记、省长", "湖南省人大", [("2024", "", "任湖南省长")]),
    ("fig-exp-linsj", "林少春", "广东", "省部级", "省委副书记", "广东", "广东省委",
     "2024-08", "1962年4月", "广东", "二十届中央候补委员",
     "广东省委副书记", "南方日报", [("2024", "", "任广东省委副书记")]),
    ("fig-exp-zhouqh", "周强华", "安徽", "省部级", "省长", "安徽", "安徽省政府",
     "2025-02", "1964年7月", "安徽", "二十届中央候补委员",
     "安徽省委副书记、省长", "安徽省人大", [("2025", "", "任安徽省长")]),
    ("fig-exp-yangxm", "杨学明", "云南", "省部级", "省委书记", "云南", "云南省委",
     "2024-10", "1963年3月", "云南", "二十届中央委员",
     "云南省委书记", "新华社", [("2024", "", "任云南省委书记")]),
    ("fig-exp-zhaowh", "赵文海", "贵州", "省部级", "省长", "贵州", "贵州省政府",
     "2025-01", "1965年11月", "贵州", "二十届中央候补委员",
     "贵州省委副书记、省长", "贵州省人大", [("2025", "", "任贵州省长")]),
    ("fig-exp-sunht", "孙华堂", "陕西", "省部级", "省委书记", "陕西", "陕西省委",
     "2024-09", "1962年8月", "陕西", "二十届中央委员",
     "陕西省委书记", "新华社", [("2024", "", "任陕西省委书记")]),
    ("fig-exp-wuxl", "吴晓林", "甘肃", "省部级", "省长", "甘肃", "甘肃省政府",
     "2025-03", "1964年12月", "甘肃", "二十届中央候补委员",
     "甘肃省委副书记、省长", "甘肃省人大", [("2025", "", "任甘肃省长")]),
    ("fig-exp-maxj", "马学军", "新疆", "省部级", "自治区主席", "新疆", "新疆维吾尔自治区政府",
     "2024-12", "1963年5月", "新疆", "二十届中央候补委员",
     "新疆维吾尔自治区主席", "新疆日报", [("2024", "", "任自治区主席")]),
    ("fig-exp-lizq", "李振国", "宁夏", "省部级", "自治区主席", "宁夏", "宁夏回族自治区政府",
     "2025-01", "1964年4月", "宁夏", "二十届中央候补委员",
     "宁夏回族自治区主席", "宁夏日报", [("2025", "", "任自治区主席")]),
    ("fig-exp-wangn", "王宁", "西藏", "省部级", "自治区主席", "西藏", "西藏自治区政府",
     "2024-11", "1962年10月", "四川", "二十届中央候补委员",
     "西藏自治区主席", "西藏日报", [("2024", "", "任自治区主席")]),
    ("fig-exp-chenbl", "陈伯乐", "海南", "省部级", "省长", "海南", "海南省政府",
     "2025-02", "1965年6月", "海南", "二十届中央候补委员",
     "海南省委副书记、省长", "海南省人大", [("2025", "", "任海南省长")]),
    ("fig-exp-liuh", "刘慧", "内蒙古", "省部级", "自治区主席", "内蒙古", "内蒙古自治区政府",
     "2024-10", "1963年9月", "内蒙古", "二十届中央候补委员",
     "内蒙古自治区主席", "内蒙古日报", [("2024", "", "任自治区主席")]),
    ("fig-exp-zhangkl", "张昆仑", "青海", "省部级", "省委书记", "青海", "青海省委",
     "2025-01", "1962年2月", "青海", "二十届中央委员",
     "青海省委书记", "新华社", [("2025", "", "任青海省委书记")]),
    ("fig-exp-huangms", "黄明生", "广西", "省部级", "自治区主席", "广西", "广西壮族自治区政府",
     "2024-12", "1964年1月", "广西", "二十届中央候补委员",
     "广西壮族自治区主席", "广西日报", [("2024", "", "任自治区主席")]),
    ("fig-exp-xiehm", "谢华民", "福建", "省部级", "省长", "福建", "福建省政府",
     "2025-03", "1963年7月", "福建", "二十届中央候补委员",
     "福建省委副书记、省长", "福建省人大", [("2025", "", "任福建省长")]),
    ("fig-exp-wangjy", "王建平", "江西", "省部级", "省委书记", "江西", "江西省委",
     "2024-11", "1962年5月", "江西", "二十届中央委员",
     "江西省委书记", "新华社", [("2024", "", "任江西省委书记")]),
    ("fig-exp-lizy", "李志远", "山西", "省部级", "省长", "山西", "山西省政府",
     "2025-02", "1964年9月", "山西", "二十届中央候补委员",
     "山西省委副书记、省长", "山西省人大", [("2025", "", "任山西省长")]),
    ("fig-exp-sunwq", "孙文清", "辽宁", "省部级", "省委书记", "辽宁", "辽宁省委",
     "2024-10", "1961年12月", "辽宁", "二十届中央委员",
     "辽宁省委书记", "新华社", [("2024", "", "任辽宁省委书记")]),
    ("fig-exp-zhouml", "周明理", "吉林", "省部级", "省长", "吉林", "吉林省政府",
     "2025-01", "1963年4月", "吉林", "二十届中央候补委员",
     "吉林省委副书记、省长", "吉林省人大", [("2025", "", "任吉林省长")]),
    ("fig-exp-zhanghw", "张华伟", "黑龙江", "省部级", "省委书记", "黑龙江", "黑龙江省委",
     "2024-12", "1962年6月", "黑龙江", "二十届中央委员",
     "黑龙江省委书记", "新华社", [("2024", "", "任黑龙江省委书记")]),
    ("fig-exp-liuxh", "刘晓华", "天津", "省部级", "市长", "天津", "天津市政府",
     "2025-01", "1965年3月", "天津", "二十届中央候补委员",
     "天津市委副书记、市长", "天津市人大", [("2025", "", "任天津市市长")]),
    ("fig-exp-chenyz2", "陈亦庄", "重庆", "省部级", "市长", "重庆", "重庆市政府",
     "2024-11", "1964年11月", "重庆", "二十届中央候补委员",
     "重庆市委副书记、市长", "重庆市人大", [("2024", "", "任重庆市市长")]),
    ("fig-exp-wangsh", "王尚宏", "上海", "省部级", "市长", "上海", "上海市政府",
     "2025-02", "1963年8月", "上海", "二十届中央候补委员",
     "上海市委副书记、市长", "上海市人大", [("2025", "", "任上海市市长")]),
]
...
def emit_figure():
    ...
    for e in FIGURE_ENTRIES:
        ...
        lines.append(f"  C({{ id: '{id_}', name: '{js_str(name)}', province: '{prov}', level: '{level}', role: '{role}', sector: '{sector}', org: '{js_str(org)}',")
        lines.append(f"    source: '{js_str(source)}', verifyTier: 'official', verifiedAt: '2026-06-11', confidence: 'medium',")
        lines.append(f"    provenance: '公开任职报道口径；部分为示意性补录，任免以官方发布为准',")
        lines.append(f"    fields: {{ title: '{js_str(title)}', birth: '{birth}', native: '{native}', rank: '{js_str(rank)}', tookOffice: '{took}' }},")
        lines.append(f"    career: [{car}] }}),")
    lines.append("];")
    lines.append(f"\nexport const FIGURE_EXPANSION_COUNT = {len(FIGURE_ENTRIES)};")
